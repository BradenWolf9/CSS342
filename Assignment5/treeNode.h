...
public:
 ...
 /**
   ...
   * in the makeEmpty function
   * @post Returns a boolean to threadedBST makeEmpty
   * @return true 
   * @return false 
   */
  bool emptyIsLeaf() const;
 ...
 /**
   * @brief Comparison Operator that checks equality
  ...
  /**
   * @brief Comparison Operator that checks less than
   * @pre TreeNode passed in on right are not nullptr values 
   * @post Returns true or false depending on given operator
   * @param right
   * @return bool
  ...
  /**
   * @brief Comparison Operator that checks greater tan
   * @pre TreeNode passed in on right are not nullptr values 
   * @post Returns true or false depending on given operator
   * @param right
   * @return bool
